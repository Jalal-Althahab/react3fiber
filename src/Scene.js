...
export function Scene(props) {
  ...
  // Clicked state to store the colors of chairs
  ...
  return (
    <>
      <group {...props}>
        ...
        <Select enabled={hovered === "VOXLÖV"} onPointerOver={over("VOXLÖV")} onPointerOut={() => debouncedHover(null)} onClick={handleClick("VOXLÖV")}>
          <mesh geometry={nodes.table.geometry} material={materials.walls} material-envMap={env} material-envMapIntensity={0.5} />
        </Select>
        <Select enabled={hovered === "FANBYN"} onPointerOver={over("FANBYN")} onPointerOut={() => debouncedHover(null)} onClick={handleClick("FANBYN")}>
          <mesh
            geometry={nodes.chairs_1.geometry}
            material={materials.walls}
            material-color={clickedColors["FANBYN"] || materials.walls.color}
          />
          <mesh
            geometry={nodes.chairs_2.geometry}
            material={materials.plastic}
            material-color={clickedColors["FANBYN"] || "#1a1a1a"}
            material-envMap={env}
          />
        </Select>
        ...
        <Select enabled={hovered === "SKAFTET"} onPointerOver={over("SKAFTET")} onPointerOut={() => debouncedHover(null)} onClick={handleClick("SKAFTET")}>
